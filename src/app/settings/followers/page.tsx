...
export default function SettingsFollowers() {
  ...
  return (
    <div className="max-w-lg mx-auto">
      <h1 className="text-2xl font-bold mb-6">Followers & Following</h1>
      ...
      <div className="mt-8 border-t border-zinc-800 pt-4">
        <a href="/settings/profile" className="text-sm text-zinc-400 hover:text-zinc-200">Edit profile</a>
      </div>
    </div>
  );
}
